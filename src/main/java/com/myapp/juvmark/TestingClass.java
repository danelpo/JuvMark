...
public class TestingClass {
    ...
    public static void Test(){
        ...
        //PassedClassesDataSorting.endClass("ICS4U_2019-2020_1");
        //CreateClassDataSorting.createClassLink("ICS4U_2019-2020_1", "ICS4U_2017-2017_2", "ICS4U_2018-2019_2");
        //ListFiles.listCurrentClasses("Data/CurrentClasses");
        
        //StudentDataSorting.setSavedname("ICS4U_2019-2020_2");
        //StudentDataSorting.createStudentFile("Eric Herscovich*ehers1@ocdsb.ca*herscovich@rogers.com*S346910102", 1);
        
        
        CreateClassDataSorting.setSavedname("ICS4U_2019-2020_5");
        CreateClassDataSorting.setTasks("Q1_A1-A2_Lab saftey quiz", 1);
        CreateClassDataSorting.setTasks("T1_A1-A2-A2.2-A3-A4_working in a lab test", 0);
        CreateClassDataSorting.setTasks("T2_B3-B4-C2-D1_working in a lab test second", 2);
       ...
       //ListFiles.listTasks("ICS4U_2019-2020_2");
        /*
        CreateClassDataSorting.setSavedname("SCH4U_2018-2019_2");
        ...
        CreateClassDataSorting.setSavedname("ICS4U_2019-2020_2");
        ...
        CreateClassDataSorting.setSavedname("SCH4U_2019-2020_2");
